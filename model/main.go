...
func migrateDB() error {
	...
	if err := migrateRequestAuditPayloadColumnsToMediumText(DB, common.UsingMainDatabase(common.DatabaseTypeMySQL)); err != nil {
		return err
	}
...
func migrateLOGDB() error {
	...
	if err := LOG_DB.AutoMigrate(&Log{}, &RequestAudit{}); err != nil {
		return err
	}
	return migrateRequestAuditPayloadColumnsToMediumText(
		LOG_DB,
		common.UsingLogDatabase(common.DatabaseTypeMySQL),
	)
}
...
func migrateClickHouseLogDB() error {
	...
	if err := migrateRequestAuditPayloadColumnsToMediumText(
		LOG_DB,
		common.UsingLogDatabase(common.DatabaseTypeMySQL),
	); err != nil {
		return err
