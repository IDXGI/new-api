...
func TestAggregateSSETextAggregatesResponsesOutputTextDelta(t *testing.T) {
...
`)
	...
	require.Equal(t, "Hello world", aggregateSSEText(body))
}

func TestAggregateSSETextIgnoresReasoningAndToolCallDeltas(t *testing.T) {
	body := []byte(`event: response.reasoning_summary_text.delta
data: {"type":"response.reasoning_summary_text.delta","delta":"background"}
...
`)
	...
	require.Equal(t, "Visible answer", aggregateSSEText(body))
}

func TestAggregateSSETextFallsBackToCompletedResponseOutput(t *testing.T) {
...
`)
	...
	require.Equal(t, "Final answer", aggregateSSEText(body))
}

func TestAggregateSSETextSupportsChatCompletionContentDelta(t *testing.T) {
