...
// It deletes usage logs and request audits directly instead of going through the async
// system task. It is kept only for the classic frontend; the default frontend uses
